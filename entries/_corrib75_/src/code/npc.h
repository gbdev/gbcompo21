...
#ifndef __npc_h_INCLUDE
#define __npc_h_INCLUDE

extern void init_npcs(void);
extern void draw_npcs(void);
extern void npc_talk(void);

extern uint8_t npc_x;
extern uint8_t npc_y;
extern uint8_t npc_mx;
extern uint8_t npc_my;
